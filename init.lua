...
vim.api.nvim_set_keymap('n', '<leader>ti', ':ToggleTerm direction=float<CR>', opts)
...
-- control w + h/j/k/l to move between windows to control + shift + h/j/k/l to move windows
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettierd',
        'pyright',
        -- Add Docker, Compose, etc manually via Mason
      })
